...
async def save_upload_file(upload_file: UploadFile, target_path: Path) -> None:
    """Save a potentially large upload without loading it all into memory."""
...
async def start_processing(
    ...
    try:
        ...
        source_url = (project.project_metadata or {}).get("source_url")
        if not srt_path and not source_url:
