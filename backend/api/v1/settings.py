...
class ApiSettings(BaseModel):
    ...
    api_provider: str = Field(default="dashscope", description="API provider")
...
async def get_available_models():
    ...
    try:
        ...
        models = {
            ...
            "302ai": [
                {"name": "gpt-4o-mini", "display_name": "GPT-4o Mini", "max_tokens": 128000, "description": "通过 302.AI OpenAI 兼容接口访问"},
                {"name": "gpt-4o", "display_name": "GPT-4o", "max_tokens": 128000, "description": "通过 302.AI OpenAI 兼容接口访问"},
...
async def get_current_provider():
    ...
    try:
        ...
        if settings_file.exists():
            with open(settings_file, "r", encoding="utf-8") as f:
                api_settings = json.load(f).get("api", {})

        provider = api_settings.get("api_provider", api_settings.get("llm_provider", "dashscope"))
