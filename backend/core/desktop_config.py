...
class DesktopConfig:
    ...
    def _load_persisted_settings(self) -> None:
        ...
        try:
            ...
            speech_data = data.get("speech_recognition") or {}
            if not speech_data:
                return

            self.speech_recognition.method = speech_data.get("method", self.speech_recognition.method)
            self.speech_recognition.enable_fallback = speech_data.get(
                "enable_fallback",
                self.speech_recognition.enable_fallback,
            )
            self.speech_recognition.fallback_method = speech_data.get(
                "fallback_method",
                self.speech_recognition.fallback_method,
            )
            self.speech_recognition.output_format = speech_data.get(
                "output_format",
                self.speech_recognition.output_format,
            )
            ...
            for section_name in (
                ...
                section = speech_data.get(section_name) or {}
                target = getattr(self.speech_recognition, section_name)
    ...
    def to_persisted_dict(self) -> dict:
        return {
            "speech_recognition": {
                ...
                "whisper_config": asdict(self.speech_recognition.whisper_config),
                "openai_config": asdict(self.speech_recognition.openai_config),
                "azure_config": asdict(self.speech_recognition.azure_config),
                "google_config": asdict(self.speech_recognition.google_config),
                "aliyun_config": asdict(self.speech_recognition.aliyun_config),
                "custom_api_config": asdict(self.speech_recognition.custom_api_config),
                "enable_fallback": self.speech_recognition.enable_fallback,
                "fallback_method": self.speech_recognition.fallback_method,
                "output_format": self.speech_recognition.output_format,
            }
        }
...
def save_desktop_config(config: DesktopConfig) -> bool:
    try:
        ...
        data.update(config.to_persisted_dict())
